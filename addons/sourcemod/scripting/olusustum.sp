...
public OnPluginStart()
{
	...
	olusustum_flag = CreateConVar("sm_olusustum_flag", "b", "Komutçu harici kullanacak kişinin yetki bayrağı");
...
public Action BaslatOyunu(Handle timer)
{
	...
	else
	{
		...
		{
			char sBuffer[512];
			Format(sBuffer, sizeof(sBuffer), "ÖlüSustum: <font color='#00FF00'>%s</font> | Kalan Saniye: <font color='#00FF00'>%d</font>", yazilar[randomSayi], KalanSure2);
			ShowStatusMessage(-1, sBuffer, 2);
		}
	}
	KalanSure2--;
